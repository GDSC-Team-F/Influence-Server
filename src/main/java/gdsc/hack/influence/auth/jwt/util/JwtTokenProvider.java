...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${jwt.secret-key}") final String secretKey,
                            @Value("${jwt.access-token-expiration-time}") final long accessTokenValidityInMilliseconds,
                            @Value("${jwt.refresh-token-expiration-time}") final long refreshTokenValidityInMilliseconds) {
